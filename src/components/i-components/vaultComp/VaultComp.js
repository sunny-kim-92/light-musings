  ...
  componentDidUpdate() {
    if (this.state.switch) {
      if (this.state.backFlag) {
        ...
        this.setState({switch: false, nextItem: {}})
      }
      }
    }
  }
    ...
    return (
      <div>
        <Animate show={!this.state.switch} type="slide" duration={500}>
          {!this.state.finished ? (
            <Wrapper>
              {!this.state.switch && !this.state.finished ? (
                <h2>{this.state.items[0].q}</h2>
              ) : null}
              {!this.state.switch
            ...
            <div>
              <h1>{this.state.finalV[0]}</h1>
              <h1>{this.state.finalV[1]}</h1>
              <h1>{this.state.finalV[2]}</h1>
            </div>
          )}
        </Animate>
